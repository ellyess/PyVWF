"""Categorize turbine locations as onshore or offshore.

This script loads a turbine CSV, assigns domain labels using GeoJSON regions,
and filters onshore/offshore subsets.
"""
