...
PyVWF community a harassment-free experience for everyone, regardless of age,
...
PyVWF is research software. Beyond the standards above, we expect contributors
to represent results honestly: report what a method actually does, including its
limitations and the cases where it fails, and do not overstate validation
evidence. Deliberately misrepresenting a method's performance, or knowingly
contributing code that produces silently incorrect scientific results, is a
...
reported to the project maintainer at **benmoufok.ellyess@gmail.com**. All
