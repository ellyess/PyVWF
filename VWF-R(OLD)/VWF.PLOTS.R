...
##
plot_ncdf = function(data, mainTitle='', legendTitle='', lonRange=NULL, latRange=NULL, zRange=range(data, na.rm=TRUE), zConstrain=FALSE, levels=64, aspect=NULL, myColours=NULL)
{
...
##
full_ncdf = function(data, mainTitle='', legendTitle='', lonRange=NULL, latRange=NULL, zRange=range(data, na.rm=TRUE), zConstrain=FALSE, levels=1024, aspect=NULL, myColours=NULL, dateTime=FALSE)
{
...
plot_ncdf_gridded = function(lon, lat, data, xlim=range(lon), ylim=range(lat), colours=NULL, nLevels=64, zRange=range(data, na.rm=TRUE), aspect=2.5, mainTitle='', legendTitle='', fullScreen=FALSE, ...)
{
	# fix data
