...
---
title: 'PyVWF: A Wind Power Simulator'
tags:
  - Python
  - energy system model
  - wind
...
`vwf` calculated hourly power output at any given location in the world using reanalysis data from MERRA-2. The novelty of this model is the bias correction process, that is capable of achieving a R-squared score of 0.95 for national hourly power output of 23 European countries. The bias correction is done using factors on a country-wide basis with a one set of bias correction factors for each country.
