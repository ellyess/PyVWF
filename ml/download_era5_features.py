...
Downloads additional ERA5 variables that could improve correction factor prediction:
...
Setup: https://cds.climate.copernicus.eu/api-how-to
"""
...
def download_era5_invariant(output_dir='input/era5/invariant', bounds=None):
    ...
    These include orography, land-sea mask, and surface roughness.
    """
...
def download_era5_atmospheric_stability(output_dir='input/era5/stability', 
    ...
    These help characterize atmospheric conditions affecting wind profiles.
    """
    output_dir = Path(output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)
...
def download_era5_surface_roughness_time_varying(output_dir='input/era5/roughness',
    ...
    """
    Download time-varying surface roughness (changes with vegetation).
    """
    output_dir = Path(output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)
