#!/usr/bin/env python3
"""
Quick Terrain Setup - Extract from ERA5 or Download Lightweight Data

Creates a basic terrain file from your existing ERA5 data or downloads
a lightweight alternative (GEBCO bathymetry subset).

This is faster than downloading full ETOPO (1GB+).
...
def create_synthetic_terrain(bounds, resolution_deg=0.1):
    """
    Create synthetic terrain based on ERA5 orography or simple model.
    
    This is a placeholder - in production you'd use real DEM data.
    For ML training, even rough terrain estimates can provide value.
    """
...
def compute_terrain_derivatives(lats, lons, elevation, resolution_deg=0.1):
    """Compute slope, aspect, roughness, curvature from elevation."""
