...
This script summarizes model performance, feature importance, and prediction
maps for trained ML correction models.
...
def load_model_data(model_path):
    ...
    Returns:
        Dictionary with model metadata and trained estimators.
    """
...
def plot_prediction_maps(predictions_nc, output_dir):
    ...
    Args:
        predictions_nc: Path to prediction NetCDF file.
        output_dir: Directory to save plots.
    """
    print("\n" + "="*70)
...
def main():
    """Run the ML results review workflow."""
