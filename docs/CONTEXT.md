...
| accepted years | The training years whose offset was fitted and accepted. A factor averages its scalar and its offset over them, carries their count as `n_years`, and is refused when they are fewer than two thirds of the training years, rounded up (issue #28). A year with no usable observation is not one. | valid years, fitted years, usable years |
