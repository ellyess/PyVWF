...
from pyvwf.config import BoundingBoxes, PyVWFPaths
...
def prep_era5(
    ...
    Args:
        ...
        allow_extrapolation: Attached to the returned dataset, where
            ``pyvwf.wind.interpolate_wind`` reads it: whether units outside the
    ...
    from pyvwf.wind import EXTRAPOLATION_ATTR
