...
:attr:`pyvwf.config.PyVWFPaths.INPUT_ROOT` at a directory containing your own
``power_curves.csv`` and ``models.csv`` and they take precedence over these;
:func:`pyvwf.config.PyVWFPaths.reference_file` warns whenever it falls back here.
"""
