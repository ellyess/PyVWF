...
code (:mod:`pyvwf.correction`, :mod:`pyvwf.data`, :mod:`pyvwf.wind`): it adds no
...
(season name → month list, from :attr:`pyvwf.harness.regions.RegionSpec.seasons`).
...
from pyvwf.metrics import weighted_mean_by
