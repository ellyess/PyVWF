...
class ObservationSource(ABC):
    ...
    ``countries``
        ...
        :class:`~pyvwf.sources.in_memory.InMemoryCountrySource`.
    ...
    :func:`pyvwf.sources.registry.resolve` instantiates them.
    """
    ...
    def __init__(self, country: str) -> None:
        ...
        This is the constructor contract :func:`pyvwf.sources.registry.resolve`
        ...
        :class:`~pyvwf.sources.in_memory.InMemoryCountrySource`) override it with
