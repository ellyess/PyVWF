"""Registry of available :class:`~pyvwf.sources.base.ObservationSource` adapters.
...
from pyvwf.sources.base import ObsLevel, ObservationSource
...
def register(cls: type[ObservationSource]) -> type[ObservationSource]:
    ...
    Args:
        cls: The :class:`~pyvwf.sources.base.ObservationSource` subclass to
