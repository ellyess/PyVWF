...
from pyvwf.datasets.gwpt import DROP_AR, plant_key
...
def ar_plant_key(name: str) -> str:
    """The Argentina join key: :func:`pyvwf.datasets.gwpt.plant_key` with
    :data:`pyvwf.datasets.gwpt.DROP_AR`, stage numerals dropped."""
...
def join_coords_caps(fleet: pd.DataFrame, g: pd.DataFrame, overrides: pd.DataFrame):
    ...
    Args:
        ...
        g: :func:`pyvwf.datasets.gwpt.projects_with_keys` for Argentina with
            :func:`ar_plant_key`.
