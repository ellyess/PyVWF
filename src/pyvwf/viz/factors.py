...
:func:`pyvwf.sampling.cluster_with_geometries`, which uses the same
    ...
    *,
    ...
    Args:
        factors: Correction-factor table for one ``(n_clu, time_res)``
            ...
            :func:`pyvwf.viz.load_results` (``Results.factors``). Must contain
    ...
    from pyvwf.sampling import cluster_with_geometries
