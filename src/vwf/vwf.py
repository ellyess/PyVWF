...
class PyVWF:
    ...
    def from_config(
        ...
        **kwargs
        ...
        .. deprecated:: 0.6.0
            Nothing in PyVWF calls this method. It imports generated code by
            inserting a directory into ``sys.path``. Use the harness
            ``entsoe-country`` adapter with a region config instead. It will be
        ...
        warnings.warn(
            "PyVWF.from_config is deprecated and will be removed in a future "
            "release; use the harness entsoe-country adapter with a region config.",
            DeprecationWarning,
            stacklevel=2,
        )
